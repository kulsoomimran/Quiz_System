...
let question = await inquirer.prompt([
  {
    ...
    name: "one",
    message:
      "Question # 1: Which programming language is a superset of TypeScript?",
  ...
  },
  {
    ...
    name: "five",
    message:
      "Question # 5: How do you define an optional parameter in the TypeScript",
    choices: [
      "(type?: string)",
      "(type: string?)",
      "(type string=)",
...
} else console.log(chalk.red.italic("Please try again!"));
